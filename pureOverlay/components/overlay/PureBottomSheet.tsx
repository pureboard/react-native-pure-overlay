...
import { useSetPureBottomSheetHanlder } from "../../providers/Provider";
import { PureBottomSheetProps } from "../../types/services/bottomSheet/PureBottomSheetProps";
import { PureBottomSheetResolveType } from "../../types/services/bottomSheet/PureBottomSheetResolveType";
...
export const getPureBottomSheet = <PropList extends OverlayPropList>() => {
  const PureBottomSheet = <Id extends keyof PropList>({
    ...
    const setBttomSheetHandler = useSetPureBottomSheetHanlder();
